     ...
     window.addEventListener("load", function() {
      ...
      link.addEventListener("click", function(e) {
        ...
        document.getElementById('sendContact').addEventListener('click', ()=>{
          ...
          if(n && m){ note.textContent = 'Terima kasih — pesan terkirim.'; document.getElementById('cname').value=''; document.getElementById('cmsg').value=''; }
          else note.textContent = 'Lengkapi nama & pesan.';
          setTimeout(()=>note.textContent='',4500);
        });
    
        const introVideos = [
          {tag:'is', title:'Introduction to Information Systems', src:'https://www.youtube.com/embed/30-nGJ0uCAs'},
          {tag:'comp', title:'Computer & Technology Basics', src:'https://www.youtube.com/embed/y2kg3MOk1sY'},
          {tag:'comp', title:'Computer Fundamentals for Beginners', src:'https://www.youtube.com/embed/eEo_aacpwCw'},
          {tag:'net', title:'Introduction to Networking | Network Fundamentals', src:'https://www.youtube.com/embed/9SIjoeE93lo'},
          {tag:'net', title:'Networking Basics Full Course', src:'https://www.youtube.com/embed/qiQR5rTSshw'},
          {tag:'db', title:'SQL and Databases - Full Course', src:'https://www.youtube.com/embed/HXV3zeQKqGY'},
          {tag:'db', title:'SQL Tutorial for Beginners', src:'https://www.youtube.com/embed/7S_tz1z_5bA'}
        ];
    
        const advanceVideos = [
          {tag:'sa', title:'System Analysis & Design Full Lecture', src:'https://www.youtube.com/embed/X898qHM2uP0'},
          {tag:'sec', title:'Cyber Security Full Course', src:'https://www.youtube.com/embed/6XCuMC0CVYI'},
          {tag:'dm', title:'Data Science & BI Introduction', src:'https://www.youtube.com/embed/ua-CiDNNj30'}
        ];
    
        const programmingVideos = [
          {tag:'py', title:'Learn Python - Full Course', src:'https://www.youtube.com/embed/rfscVS0vtbw'},
        ...
        const recommended = [
          {title:'Apa itu Sistem Informasi? (Short Intro)', src:'https://www.youtube.com/embed/dLfpZtIacbc'},
          {title:'Computer & Technology Basics Course', src:'https://www.youtube.com/embed/y2kg3MOk1sY'},
          {title:'Cisco CCNA Introduction to Networks', src:'https://www.youtube.com/embed/ty0HMs48U1k'},
          {title:'SQL for Beginners — Full Course', src:'https://www.youtube.com/embed/HXV3zeQKqGY'},
          {title:'Learn Python - Full Course', src:'https://www.youtube.com/embed/rfscVS0vtbw'},
          {title:'JavaScript Full Course - Beginner to Pro', src:'https://www.youtube.com/embed/PkZNo7MFNFg'},
          {title:'Java Full Course for Beginners', src:'https://www.youtube.com/embed/eIrMbAQSU34'},
          {title:'PHP Full Course - Beginner to Advanced', src:'https://www.youtube.com/embed/VGBWm6xtPWs'},
          {title:'Cyber Security Fundamentals', src:'https://www.youtube.com/embed/6XCuMC0CVYI'},
          {title:'Data Science & BI Introduction', src:'https://www.youtube.com/embed/ua-CiDNNj30'}
        ];
        ...
        function filterGrid(pageKey, filter, chipEl){
          ...
          const map = {
            'intro':'grid-intro','advance':'grid-advance','programming':'grid-programming'
          };
